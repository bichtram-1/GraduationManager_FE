...
const CouncilsPage: React.FC = () => {
  ...
  // Note: create / phân công workflow moved to dedicated page (`/councils/create`).
  ...
  return (
    <div className="council-ui min-h-screen bg-[#f5f4f0] text-[#1a1916]">
      ...
      <div className="page">
        <div style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
          <div>
            <h1 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--color-text-primary)', margin: 0 }}>Quản lý Hội đồng Bảo vệ</h1>
            <p style={{ fontSize: '12px', color: 'var(--color-text-secondary)', marginTop: '6px' }}>Phân công giảng viên, đề tài và lịch bảo vệ</p>
          </div>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <button className="btn btnp" onClick={() => navigate(ROUTES.COUNCILS_CREATE)}>
