  ...
  return (
    <div className="council-ui min-h-screen bg-[#f5f4f0] text-[#1a1916]">
      <style>{`
        ...
        .council-ui .council-body { display:flex; flex-direction:column; gap:10px }
        .council-ui .role-row { display:grid; grid-template-columns:110px minmax(0,1fr); gap:12px; align-items:flex-start; border-top:1px solid var(--color-border-tertiary); padding-top:12px }
        .council-ui .role-name { font-size:12px; font-weight:600; color:var(--color-text-secondary); text-transform:uppercase; letter-spacing:.04em }
        .council-ui .role-title { font-size:13px; font-weight:600; color:var(--color-text-primary); margin-bottom:6px }
