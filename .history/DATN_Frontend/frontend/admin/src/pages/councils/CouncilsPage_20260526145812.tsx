    ...
    <div className="council-ui min-h-screen bg-[#f5f4f0] text-[#1a1916]">
      ...
      <div className="page">
        ...
        <div className="tabs" id="mainTabs">
          <div className={`tab ${mainTab === 'list' ? 'on' : ''}`} onClick={() => setMainTab('list')}>Danh sách hội đồng</div>
                  ...
                  <div className="ov-bottom">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '5px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '5px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                        ...
                        <button className="btn btns btn-xs" onClick={() => setShowExternalForm((value) => !value)}>
                          <i className="ti ti-plus" /> Thêm GV ngoài
                        </button>
                      </div>
                      <div className={showExternalForm && council.id === 'HD01' ? '' : 'hidden'} style={{ background: 'var(--color-background-secondary)', border: '0.5px solid var(--color-border-secondary)', borderRadius: 'var(--border-radius-md)', padding: '10px', width: '320px', textAlign: 'left' }}>
                        ...
                        <div style={{ display: 'flex', gap: '6px' }}>
                          <button className="btn btnp btn-xs" onClick={() => setShowExternalForm(false)}><i className="ti ti-check" /> Xác nhận</button>
                          <button className="btn btns btn-xs" onClick={() => setShowExternalForm(false)}>Huỷ</button>
                        </div>
                      </div>
                    </div>
                  </div>
