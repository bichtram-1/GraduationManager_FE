...
import { Button, Card, Form, Input, Modal, Select, Space, Table, Tag, Tabs, Typography, message } from 'antd';
      ...
      render: (_: unknown, record) => {
        ...
        return (
          <Space size={4}>
            ...
            <Button size="small" className="!h-8 !rounded-[8px]" onClick={() => openDetailConfirmation(record)}>
              Xem
            </Button>
            <Button size="small" className="!h-8 !rounded-[8px]" onClick={() => openEditConfirmation(record)}>
              Sửa
            </Button>
            <Button danger size="small" className="!h-8 !rounded-[8px]" onClick={() => deleteConfirmation(record)}>
              Xóa
            </Button>
          </Space>
        );
    ...
    },
    {
      ...
      render: (_: unknown, record) => (
        <Space size={4}>
          ...
          <Button size="small" className="!h-8 !rounded-[8px]" onClick={() => openDetailStudent(record)}>
            Xem
          </Button>
          <Button size="small" className="!h-8 !rounded-[8px]" onClick={() => openEditStudent(record)}>
            Sửa
          </Button>
          <Button danger size="small" className="!h-8 !rounded-[8px]" onClick={() => deleteStudent(record)}>
            Xóa
          </Button>
        </Space>
      ),
