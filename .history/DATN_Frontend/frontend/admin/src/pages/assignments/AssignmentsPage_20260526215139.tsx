                    ...
                    <div key={teacher.id} className="flex items-center justify-between gap-3 border border-slate-100 p-3 rounded-md">
                      <div className="flex min-w-0 flex-1 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="truncate font-medium text-slate-900">{teacher.name}</div>
                          <div className="truncate text-xs text-slate-500">{teacher.degree} {teacher.major ? `• ${teacher.major}` : ''}</div>
                        </div>
                      </div>
                      <div>
