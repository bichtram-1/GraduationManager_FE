                    ...
                    <div key={teacher.id} className="flex items-center justify-between gap-3 border border-slate-100 p-3 rounded-md">
                      <div className="flex min-w-0 flex-1 items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="block text-sm font-semibold leading-5 text-slate-900">{teacher.name}</div>
                          <div className="mt-0.5 block text-xs leading-4 text-slate-500">{teacher.degree} {teacher.major ? `• ${teacher.major}` : ''}</div>
                        </div>
                      </div>
                      <div>
