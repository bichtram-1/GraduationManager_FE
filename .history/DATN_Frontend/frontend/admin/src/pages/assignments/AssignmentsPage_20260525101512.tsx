          ...
          <Card>
            <div className="flex items-start gap-4 justify-between mb-4">
              <div className="flex-1 space-y-3">
                <Select value={listClassFilter} onChange={setListClassFilter} style={{ width: 220 }}>
                ...
                <Select value={listTeacherFilter} onChange={setListTeacherFilter} style={{ width: 220 }}>
                ...
                <Input allowClear value={listQuery} onChange={(e) => setListQuery(e.target.value)} placeholder="MSSV / tên SV..." style={{ width: 360 }} />
              </div>
              <div className="flex items-center gap-3">
                    ...
                    <tr key={r.studentId} className="border-t border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex justify-end gap-2">
                          <button onClick={() => openDetailAssignment(r)} className="text-[#0f766e]"> <EyeOutlined /> </button>
                          <button onClick={() => openEditAssignment(r)} className="text-[#2563eb]"> <EditOutlined /> </button>
                          <button onClick={() => unassign(r.studentId)} className="text-[#F44336]"> <DeleteOutlined /> </button>
                          <button onClick={() => deleteAssignment(r)} className="text-[#991b1b]">X</button>
                        </div>
                      </td>
                    </tr>
                  ))}
