...
type Segment = 'TTTN' | 'Nhóm phản biện'
  ...
  return (
    <>
      <TeacherSectionHeader
        title="Đánh giá"
        description="Theo dõi và đánh giá các nhóm TTTN, Nhóm phản biện do giảng viên đang quản lý. Danh sách này chỉ lấy dữ liệu thuộc phạm vi của giảng viên, không mở rộng theo toàn bộ tuần báo cáo."
        actions={(
          <>
      ...
      <section className="mb-5 rounded-[28px] border border-blue-100 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_100%)] p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-xl font-semibold tracking-tight text-slate-900">Chuyển giữa TTTN và Nhóm phản biện, chọn <span className="text-[#1976D2]">Đạt</span> hoặc <span className="text-[#F44336]">Không đạt</span> ngay trên bảng.</h2>
