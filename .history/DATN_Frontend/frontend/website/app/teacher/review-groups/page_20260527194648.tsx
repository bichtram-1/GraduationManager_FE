                  ...
                  return (
                    <tr key={group.id} className={`border-t border-slate-100 transition hover:bg-slate-50/80 ${selected ? 'bg-blue-50/60' : ''}`}>
                      ...
                      <td className="px-5 py-4 text-slate-900">
                        <div className="font-medium">{group.latestReport}</div>
                        <div className="mt-1 text-xs text-slate-500">{group.company}</div>
                      </td>
            ...
            {selectedGuidanceGroup ? (
              <>
                <div className="rounded-3xl bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_100%)] p-4">
                  ...
                  <div className="mt-1 text-sm text-slate-600">{selectedGuidanceGroup.leader}</div>
                  <div className="mt-4 space-y-2 text-sm text-slate-600">
                    <div className="flex items-center gap-2"><Users className="h-4 w-4 text-[#1976D2]" /> {selectedGuidanceGroup.company}</div>
                    <div className="flex items-center gap-2"><FileText className="h-4 w-4 text-[#1976D2]" /> {selectedGuidanceGroup.latestReport}</div>
