 ...
 * @param options.source The source collection from which the annotations will be taken.
 * @param options.target The target collection that will be synced to the source collection.
