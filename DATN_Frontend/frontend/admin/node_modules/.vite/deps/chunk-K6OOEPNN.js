  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component4 = component || React12.Fragment;
        var motionProps = {};
        ...
        return React12.createElement(Component4, restProps, keyEntities.map(function(_ref2, index) {
...
var genCalc = function genCalc2(type, unitlessCssVar) {
  var Calculator = type === "css" ? CSSCalculator : NumCalculator_default;
  return function(num) {
...
var IconNode = (props) => {
  ...
  if (icon) {
    return replaceElement(icon, React20.createElement("span", {
      className: `${prefixCls}-icon`
    }, icon), () => ({
      className: (0, import_classnames2.default)(`${prefixCls}-icon`, icon.props.className)
    }));
  }
  return React20.createElement(iconType, {
    className: `${prefixCls}-icon`
  });
};
var CloseIconNode = (props) => {
  ...
  const mergedCloseIcon = closeIcon === true || closeIcon === void 0 ? React20.createElement(CloseOutlined_default, null) : closeIcon;
  return isClosable ? React20.createElement("button", Object.assign({
    type: "button",
    onClick: handleClose,
...
var Alert = React20.forwardRef((props, ref) => {
  const {
    description,
    ...
    action,
    id
  } = props, otherProps = __rest3(props, ["description", "prefixCls", "message", "banner", "className", "rootClassName", "style", "onMouseEnter", "onMouseLeave", "onClick", "afterClose", "showIcon", "closable", "closeText", "closeIcon", "action", "id"]);
  const [closed, setClosed] = React20.useState(false);
  if (true) {
  ...
  const type = React20.useMemo(() => {
    if (props.type !== void 0) {
      return props.type;
    }
    return banner ? "warning" : "info";
  }, [props.type, banner]);
  const isClosable = React20.useMemo(() => {
  ...
  const mergedCloseIcon = React20.useMemo(() => {
    if (typeof closable === "object" && closable.closeIcon) {
  ...
  const mergedAriaProps = React20.useMemo(() => {
    const merged = closable !== null && closable !== void 0 ? closable : contextClosable;
    if (typeof merged === "object") {
      const {
        closeIcon: _
      } = merged, ariaProps = __rest3(merged, ["closeIcon"]);
      return ariaProps;
    }
    return {};
  }, [closable, contextClosable]);
  return wrapCSSVar(React20.createElement(es_default, {
    visible: !closed,
    ...
    style: motionStyle
  }, setRef) => React20.createElement("div", Object.assign({
    id,
    ...
    onClick,
    role: "alert"
  }, restProps), isShowIcon ? React20.createElement(IconNode, {
    description,
    icon: props.icon,
    prefixCls,
    type
  ...
  }, message ? React20.createElement("div", {
    className: `${prefixCls}-message`
  }, message) : null, description ? React20.createElement("div", {
    className: `${prefixCls}-description`
  }, description) : null), action ? React20.createElement("div", {
    className: `${prefixCls}-action`
  }, action) : null, React20.createElement(CloseIconNode, {
    isClosable,
    prefixCls,
...
var ErrorBoundary = function(_React$Component) {
  ...
  return _createClass(ErrorBoundary2, [{
    ...
    value: function render() {
      ...
      if (error) {
        return React21.createElement(Alert_default, {
          id,
          type: "error",
          message: errorMessage,
          description: React21.createElement("pre", {
            style: {
              fontSize: "0.9em",
              overflowX: "auto"
            }
...
//# sourceMappingURL=chunk-K6OOEPNN.js.map
