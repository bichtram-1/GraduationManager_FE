...
import { Spin, message, Empty, Input } from 'antd'
import { Clock, Search, ArrowRight, User, Users, ClipboardCheck, AlertTriangle } from 'lucide-react'
...
const ACTION_META: Record<string, { label: string; color: string; icon: React.ComponentType<{ className?: string }> }> = {
  KHAI_BAO_THUC_TAP: { label: 'Khai báo TTTN', color: 'bg-emerald-50 text-emerald-700 border-emerald-200', icon: ClipboardCheck },
  CAP_NHAT_KTTN: { label: 'Cập nhật TTTN', color: 'bg-emerald-50 text-emerald-700 border-emerald-200', icon: ClipboardCheck },
